...
export const useTheme = props => {
  ...
  const [columns, setColumns] = React.useState(props.columns ?? NeatTheme.columns)
  const [direction, setDirection] = React.useState(props.direction ?? NeatTheme.direction)
